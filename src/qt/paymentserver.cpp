...
const QString BITCOIN_IPC_PREFIX("factoken:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click factoken: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start factoken: click-to-pay handler");
    else
...
{
    // clicking on factoken: URLs creates FileOpen events on the Mac:
