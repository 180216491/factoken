...
#if defined(NDEBUG)
# error "Factoken cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Factoken Signed Message:\n";
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal Factoken miner
