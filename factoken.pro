...
# also add new translations to src/qt/factoken.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/factoken_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/factoken.rc
...
windows:RC_FILE = src/qt/res/factoken.rc
...
macx:ICON = src/qt/res/icons/factoken.icns
macx:TARGET = "factoken"
