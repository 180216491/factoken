#############################################################################
# Makefile for building: factoken
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 7? 20 17:13:47 2018
# Project:  factoken.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe -o Makefile factoken.pro
#############################################################################
...
Makefile: factoken.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/factoken/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/factoken/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/factoken/src/leveldb/libleveldb.a: FORCE
	cd C:/factoken/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -O2" libleveldb.a libmemenv.a && ranlib C:/factoken/src/leveldb/libleveldb.a && ranlib C:/factoken/src/leveldb/libmemenv.a
