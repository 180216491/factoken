...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/factoken-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/factoken-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/factoken-paymentack";
