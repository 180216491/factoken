...
public final class MonetaryFormat {
    ...
    public static final MonetaryFormat PPC = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 8);
    ...
    public static final String CODE_PPC = "xxUnit";
    /** Currency code for base 1/1000 Peercoin. */
    public static final String CODE_MPPC = "mxxUnit";
    /** Currency code for base 1/1000000 Peercoin. */
    public static final String CODE_UPPC = "µxxUnit";
...
//        }
//        return str;
        return FormatUtils.formatStr(monetary.getValue());
    }
    ...
    /**
     * Parse a human readable fiat value
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
