...
//        Log.i(" ", "-----numTransactions = " + numTransactions);
...
//        Log.i(" ", "-------parseTransactions finish");
    ...
    public Sha256Hash getHash() {
        if (version > 6) {
            ...
            return new Sha256Hash("e9b2d91eeaf53da0ffd0c1e662b56794f2b514deca4909456e056eb4ead8da83");
        }
    }
