...
public class TransactionBroadcast {
    ...
    public ListenableFuture<Transaction> broadcast() {
        log.info("-------zm-----Waiting for {} peers required for broadcast ...", minConnections);
    ...
    private class EnoughAvailablePeers implements Runnable {
        ...
        public void run() {
            ...
            log.info("-------zm-----broadcastTransaction: We have {} peers, adding {} to the memory pool and sending to {} peers, will wait for {}: {}",
            ...
            for (Peer peer : peers) {
                try {
                    ...
                    log.error("-------zm-----Caught exception sending to {}", peer, e);
                }
            }
    ...
    private class ConfidenceChange implements TransactionConfidence.Listener {
        ...
        public void onConfidenceChanged(Transaction tx, ChangeReason reason) {
            ...
            log.info("-------zm-----broadcastTransaction: {}:  TX {} seen by {} peers{}", reason, pinnedTx.getHashAsString(),
            ...
            if (numSeenPeers >= numWaitingFor || mined) {
                ...
                log.info("-------zm-----broadcastTransaction: {} complete", pinnedTx.getHashAsString());
