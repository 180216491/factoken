...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String WALLET_FILENAME_PROTOBUF = "factoken-wallet-protobuf";

		/** Filename of the automatic key backup (old format, can only be read). */
		public static final String WALLET_KEY_BACKUP_BASE58 = "factoken-key-backup-base58";

		/** Filename of the automatic wallet backup. */
		public static final String WALLET_KEY_BACKUP_PROTOBUF = "factoken-key-backup-protobuf";

		/** Manual backups go here. */
		public static final File EXTERNAL_WALLET_BACKUP_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "factoken-wallet-backup";

        /** Filename of exported transactions. */
        public static final String TX_EXPORT_NAME = "factoken-transactions";
        ...
        public static final String PEERS_FILENAME = "factokens";
	}
	...
	public static final String MIMETYPE_TRANSACTION = "application/x-factoken-tx";

	/** MIME type used for transmitting wallet backups. */
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-factoken-wallet-backup";
	...
	public static final String USER_AGENT = "factoken Wallet";
...
//		public static final String EXPLORE_BASE_URL = "http://10.0.0.193:3002/";
	public static final String EXPLORE_BASE_URL = "http://chain.electionchain.com/";
