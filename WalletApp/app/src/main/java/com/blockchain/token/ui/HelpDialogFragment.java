...
public final class HelpDialogFragment extends DialogFragment
{
	...
	public static void page(final FragmentManager fm, final int titleResId, final int messageResId)
	{
		final DialogFragment newFragment = HelpDialogFragment.instance(titleResId, messageResId);
		newFragment.show(fm, FRAGMENT_TAG);
	}

	private static HelpDialogFragment instance(final int titleResId, final int messageResId)
	{
