...
package com.blockchain.token.integration.android;
...
public final class PeercoinIntegration
{
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.blockchain.token"));
