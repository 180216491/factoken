...
public final class AddressBookActivity extends AbstractWalletActivity
{
	...
	private MineAddressesFragment walletAddressesFragment;
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		walletAddressesFragment = (MineAddressesFragment) fragmentManager.findFragmentByTag(TAG_LEFT);
		...
		if (walletAddressesFragment == null)
			walletAddressesFragment = new MineAddressesFragment();
		else
		...
		if (pager != null)
		{
			final RadioGroup group = (RadioGroup) findViewById(R.id.address_book_group);
