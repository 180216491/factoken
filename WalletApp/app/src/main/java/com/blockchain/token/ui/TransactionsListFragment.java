    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        activity.runAfterLoad(new Runnable () {
            ...
            public void run() {
                ...
                if(direction == null){
                    Log.i(" ", "----------set direction = " + adapter);
                    activity.setTxListAdapter(adapter);
                }
            }
                    ...
                    public boolean onCreateActionMode(final ActionMode mode, final Menu menu) {
                        ...
                        try {
                            ...
                            if (tx.isCoinBase())
                                ...
                                label = getString(R.string.send_to_me);
...
//                                mode.finish();
                                String url = Constants.EXPLORE_BASE_URL + "tx/" + tx.getHashAsString();
    ...
    public static class TransactionsLoader extends AsyncTaskLoader<List<Transaction>>
    {
        ...
        public TransactionsLoader(final Context context, @Nonnull final Wallet wallet, @Nullable final Direction direction)
        {
            super(context);
