...
import com.blockchain.token.ui.AddressBookActivity;
import com.blockchain.token.ui.HelpDialogFragment;
	...
	public boolean onOptionsItemSelected(final MenuItem item)
	{
		switch (item.getItemId())
		{
			...
			case R.id.send_coins_options_help:
				HelpDialogFragment.page(getFragmentManager(), R.string.button_help, R.string.help_send_coins);
				return true;
